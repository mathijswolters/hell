<template>
  ...
  >
    ...
    >
      <span class="font-Rubik font-bold text-white text-base flex items-center gap-2 h-full">
        HISTORY
      </span>
      <!-- Check boxes -->
      <div class="flex items-center gap-x-4 h-full">
        ...
        >
          ...
          <span class="text-base font-Rubik text-white font-bold">{{ option.label }}</span>
        </label>
      </div>
      <XMarkIcon
    ...
    <div class="flex items-center pt-4 flex-col gap-2 px-4">
      ...
      <div class="w-full flex items-center justify-center sm:justify-between flex-wrap gap-2">
        <!-- Left -->
        <div class="flex items-center w-full max-w-[397px] justify-center sm:justify-start">
          <div class="relative max-w-[397px] w-full flex items-center rounded-sm h-[46px]">
            <input
              type="text"
        ...
        >
          ...
          <div
            ...
            :class="{
              ...
              'w-[387px] h-[345px] opacity-100 top-full mt-1.5 z-10': dropdown == 'date'
            }"
          >
            <DatePicker
              :class="{
      ...
      >
        <div class="w-full overflow-y-auto max-h-[50vh] 2xl:max-h-[70vh] overflow-x-auto">
          ...
          <div class="flex flex-col w-[1432px] items-start">
            ...
            >
              <div class="font-Rubik text-[#d7b7b7] text-sm font-semibold text-center">GAME ID</div>
              <div class="text-center font-Rubik text-[#d7b7b7] text-sm font-semibold">TYPE</div>
              <div
                class="font-Rubik text-[#d7b7b7] text-sm font-semibold text-left bg-red col-span-2"
              >
                STATUS
              </div>
              <div class="font-Rubik text-[#d7b7b7] text-sm font-semibold text-left col-span-3">
                WINNER
              </div>
              <div class="col-span-3 font-Rubik text-[#d7b7b7] text-sm font-semibold text-left">
                ITEMS
              </div>
              <div class="col-span-2 font-Rubik text-[#d7b7b7] text-sm font-semibold text-left">
                TOTAL
              </div>
              <div class="text-left font-Rubik text-[#d7b7b7] text-sm font-semibold col-span-2">
                DATE
              </div>
              ...
              >
                ...
                <div
                  ...
                  :class="{
                    ...
                    'text-[#FEBD11]': item.state == 'spinning' || item.state == 'flipping'
                  }"
                >
                ...
                >
                  <div class="h-[36px] bg-[#FF3435] w-px opacity-20 absolute right-2"></div>
                  <div
                    v-if="
                  ...
                  >
                    ...
                    >
                      <img src="../assets/icons/questionMark.png" class="w-[13.58px] h-[17.5px]" />
                      <img
                  ...
                  <div v-if="item.type == 'coinflip'">
                    <div class="flex items-center justify-start w-full relative">
                      ...
                      >
                        ...
                        >
                          <img
                            :src="`/img/coins/${item.players[0].coin}.png`"
                      ...
                      <div v-else class="flex items-center gap-4">
                        <div
                          class="relative flex items-center transition-opacity duration-200 order-1"
                          :class="{
                            'opacity-40 ': !item.players[0].win && item.state == 'completed'
                          }"
                        >
                          <img
                            :src="`/img/coins/${item.players[0].coin}.png`"
                        ...
                        <span class="order-2 font-Rubik text-[#d7b7b7] text-sm font-semibold"
                          >VS</span
                        >
                        <div
                          class="relative flex items-center transition-opacity duration-200 order-3"
                          :class="{
                            'opacity-40': !item.players[1].win && item.state == 'completed'
                          }"
                        >
                          <img
                            :src="`/img/coins/${item.players[1].coin}.png`"
                            class="w-[1.5rem] absolute border-[2px] border-[#740c0a] rounded-full -left-3 z-10"
                          />
                          <UserImage :user="item.players[1]" />
                        </div>
                      </div>
                      <hr class="absolute bg-[#ff3435] right-0 h-[36px] w-px opacity-30" />
                    </div>
                  </div>
                  <span
                    v-if="
                  ...
                  >
                    ...
                    ></div>
                    <span class="opacity-50 text-white font-bold font-Rubik text-sm">+12</span>
                  </div>
                </div>
                <div
