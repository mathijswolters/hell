<template>
  ...
  >
    <!-- Header Start -->
    <div class="flex justify-center w-full h-[59px] items-center px-4 border-b border-[#620101]">
    ...
    <div class="flex items-center pt-4 flex-col gap-2">
      ...
      <div class="flex w-full items-center flex-col pt-4 min-h-[6rem] h-full">
        <div class="w-full overflow-y-auto h-auto max-h-[57vh] overflow-x-auto">
          <div class="flex flex-col gap-y-2 w-[1432px] items-start" :key="tab + '-' + current_page">
            <!-- title start -->
            <div
            ...
            >
                                  ...
                                  : tab == 'most_profit'
                                    ...
                                    : tab == 'highest_24H_profit'
                                      ...
                                      : tab == 'highest_24H_lost'
                                        ? 'HIGHEST LOST'
                                        : tab == 'highest_average_coinflip_amount'
                                          ? 'HIGHEST AVERAGE COINFLIP AMOUNT'
                                          : tab == 'highest_average_jackpot_amount'
                                            ? 'HIGHEST AVERAGE JACKPOT AMOUNT'
                                            : tab == 'most_coinflip_created'
              ...
              <div
                ...
                :class="{
                  'col-span-2':
                    ...
                    tab === 'most_jackpot_entries',
                  'col-span-3':
                    tab === 'most_double_downs' || tab === 'highest_double_down_win_streak'
                }"
              >
                {{
                  tab == 'biggest_coinflip_win'
              ...
              <div
                ...
                "
                :class="{
                  'col-span-2': tab === 'most_double_downs',
                  'col-span-3': tab == 'highest_double_down_win_streak'
                }"
              >
                {{
                  tab == 'biggest_jackpot_win'
              ...
              <div v-if="tab === 'biggest_coinflip_win' || tab === 'biggest_jackpot_win'"></div>
            </div>
            <!-- title end -->
            <!-- table start -->
            <div
                  ...
                  >
                    ...
                    >
                      <div
                        ...
                        :class="{
                          'bg-[linear-gradient(270deg,#660505_0%,rgba(102,5,5,0)_100%)]':
                            !checkUser(item),
                          'bg-[linear-gradient(270deg,#240101_0%,rgba(36,1,1,0))_100%)]':
                            checkUser(item)
                        }"
                      ></div>
                      <img
                            ...
                            : tab === 'biggest_jackpot_win'
                              ...
                              : tab === 'highest_24H_profit'
                                ...
                                : tab === 'highest_24H_lost'
                                  ? item.highest_lost
                                  : tab === 'highest_average_coinflip_amount'
                                    ? item.highest_average_coinflip_amount
                                    : tab === 'highest_average_jackpot_amount'
                                      ? item.highest_average_jackpot_amount
                                      : tab === 'biggest_pussy'
                    ...
                    <span
                      ...
                      :class="{
                        ...
                        'text-[#D7B7B7]':
                          ...
                          tab !== 'most_coinflip_created',
                        'text-[#04AB53]':
                          tab === 'most_coinflip_joined' || tab === 'most_coinflip_created'
                      }"
                    >
                      {{
                        tab === 'highest_average_jackpot_amount'
                  ...
                  >
                    ...
                    <span
                      ...
                      :class="{
                        ...
                        'text-[#C4C4C4]': item.rank === 2 && tab !== 'most_gambled',
                        'text-[#A87A23]': item.rank === 3 && tab !== 'most_gambled',
                        'text-white': item.rank > 3 && tab !== 'most_gambled'
                      }"
                    >
                      ${{
                        Number(item.total_amount_double_downed).toLocaleString(undefined, {
                          maximumFractionDigits: 2,
                          minimumFractionDigits: 2
                        })
                      }}
                    ...
                    <span
                      ...
                      :class="{
                        'text-[#EFBF04]': item.rank === 1 && tab === 'most_double_downs',
                        'text-[#C4C4C4]': item.rank === 2 && tab === 'most_double_downs',
                        'text-[#A87A23]': item.rank === 3 && tab === 'most_double_downs',
                        'text-[#D7B7B7]': item.rank > 3 && tab === 'most_double_downs',
                        'text-[#FF3435]': tab !== 'most_double_downs'
                      }"
                    >
                      {{ tab === 'most_double_downs' ? item.total_played : item.lost }}
                    </span>
                  </div>
                  <div
              ...
              >
                ...
                >
                              ...
                              : tab === 'highest_24H_profit'
                                ...
                                : tab === 'highest_24H_lost'
                                  ...
                                  : tab === 'highest_average_coinflip_amount'
                                    ...
                                    : tab === 'highest_average_jackpot_amount'
                                      ? userData.highest_average_jackpot_amount
                                      : tab === 'biggest_pussy'
                  ...
                  >
                    ...
                    >
                      ${{
                        Number(userData.total_amount_double_downed).toLocaleString(undefined, {
                          maximumFractionDigits: 2,
                          minimumFractionDigits: 2
                        })
                      }}
                    ...
                    <span
                      ...
                      class="font-Rubik text-xs font-bold flex gap-x-px justify-center"
                      :class="{
                        'text-[#D7B7B7]': tab === 'most_double_downs',
                        'text-[#FF3435]': tab !== 'most_double_downs'
                      }"
                    >
                      {{ tab === 'most_double_downs' ? userData.total_played : userData.lost }}
                    </span>
                  </div>
                  <div
                    class="col-span-2 text-left font-Rubik text-white opacity-50 text-sm font-semibold"
  ...
  data() {
    return {
      ...
      HOF: {
        ...
        highest_average_jackpot_amount: [
          {
            rank: 1,
            name: 'qusai',
            avatar: 'https://i.pinimg.com/236x/05/41/59/054159cb16d09475bc6eba72e41699e4.jpg',
            _id: 1,
            highest_average_jackpot_amount: 90290,
        ...
        most_double_downs: [
          {
            ...
            _id: 1,
            double_downs: 123,
            average_double_down_amount: 123,
            total_played: 12
          },
          {
            rank: 2,
      ...
      buttonGroups: [
        [
          ...
          { label: 'Highest Coinflip Loss Streak', value: 'highest_coinflip_loss_streak' },
        ...
        [
          ...
          { label: 'Highest Average Coinflip Amount', value: 'highest_average_coinflip_amount' },
          { label: 'Highest Average Jackpot Amount', value: 'highest_average_jackpot_amount' },
          { label: 'Most Coinflip Created', value: 'most_coinflip_created' },
          { label: 'Most Coinflip Joined', value: 'most_coinflip_joined' }
        ],
        [
          { label: 'Most Double Downs', value: 'most_double_downs' },
          { label: 'Highest Double Down Win Streak', value: 'highest_double_down_win_streak' },
