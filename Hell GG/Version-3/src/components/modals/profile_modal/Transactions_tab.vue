<template>
  <div class="relative w-full flex-col transform transition-all">
    ...
    <div class="flex items-center flex-col gap-2">
      <!-- controls start -->
      <div class="w-full flex items-center justify-center gap-4 lg:justify-between flex-wrap">
        <!-- Left -->
      ...
      <div class="flex w-full items-center flex-col pt-3 min-h-[6rem] h-full">
        <div class="w-full overflow-y-auto max-h-[95vw] overflow-x-auto">
          <div class="flex flex-col w-[1432px] items-start">
            ...
            >
              <div class="font-Rubik text-[#d7b7b7] text-sm font-semibold text-start">ID</div>
              <div class="text-start font-Rubik text-[#d7b7b7] text-sm font-semibold">TYPE</div>
              ...
              <div class="font-Rubik text-[#d7b7b7] text-sm font-semibold text-start">AMOUNT</div>
              <div class="font-Rubik text-[#d7b7b7] text-sm font-semibold text-start">
                CLOSING BALANCE
              </div>
