<template>
  ...
  <div class="flex gap-2 w-full flex-wrap xl:flex-nowrap affiliates">
    <!-- left -->
    <div class="lg:h-full w-full xl:max-w-[489px] flex flex-col gap-y-2">
          ...
          >
            ...
            <div
              ...
              :class="{
                ...
                'w-[387px] h-[345px] opacity-100 top-full mt-1.5 z-10': active_dropdown == 'date'
              }"
            >
              <DatePicker
                :class="{
