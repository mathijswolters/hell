<template>
  ...
  >
    ...
    >
      ...
      <button
        class="min-h-8 px-2.5 py-1 bg-[#ff3435] rounded-sm justify-center items-center gap-2.5 inline-flex overflow-hidden text-white text-base font-extrabold font-Rubik uppercase leading-normal"
      >
        verify
      </button>
    </div>
...
import Row from './JackpotRow.vue'
