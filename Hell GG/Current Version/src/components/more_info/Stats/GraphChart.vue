<template>
  <div class="h-[300px] w-full my-5 relative">
    ...
    <div id="more-stats-chartjs-tooltip" class="custom-tooltip"></div>
  </div>
</template>
<script>
        ...
        plugins: {
          ...
          tooltip: {
            ...
            external: (context) => {
              ...
              const tooltipEl = document.getElementById("more-stats-chartjs-tooltip");
                ...
                tooltipEl.innerHTML = `
                  <div class='bg-[#620101] p-3 rounded-sm flex flex-col w-max border border-solid border-[rgba(255,52,53,0.4)] shadow-2xl'>
                      ...
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] border-b border-white/10 py-2'>
                          <span class='text-white font-[400]'>JACKPOT WAGERED</span>
                          <span class='text-white font-[800] flex items-center gap-1'>
                            <img src="/img/dollarCoin.png" alt="dollar" width="16" />
                            ${value.toLocaleString()}</span>
                      </div>
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] border-b border-white/10 py-2'>
                          <span class='text-white font-[400]'>JACKPOT PROFIT</span>
                          <span class='text-white font-[800] flex items-center gap-1'>
                            <img src="/img/dollarCoin.png" alt="dollar" width="16" />
                            ${value.toLocaleString()}</span>
                      </div>
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] border-b border-white/10 py-2'>
                          <span class='text-white font-[400]'>JACKPOT RAKED</span>
                          <span class='text-white font-[800] flex items-center gap-1'>
                            <img src="/img/dollarCoin.png" alt="dollar" width="16" />
                            ${value.toLocaleString()}</span>
                      </div>
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] border-b border-white/10 py-2'>
                          <span class='text-white font-[400]'>AFFILIATES EARNED</span>
                          <span class='text-white font-[800] flex items-center gap-1'>
                            <img src="/img/dollarCoin.png" alt="dollar" width="16" />
                            ${value.toLocaleString()}</span>
                      </div>
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] border-b border-white/10 py-2'>
                          <span class='text-white font-[400]'>WITHDRAWN</span>
                          <span class='text-white font-[800] flex items-center gap-1'>
                            <img src="/img/dollarCoin.png" alt="dollar" width="16" />
                            ${value.toLocaleString()}</span>
                      </div>
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] border-b border-white/10 py-2'>
                          <span class='text-white font-[400]'>COINFLIP WAGERED</span>
                          <span class='text-white font-[800] flex items-center gap-1'>
                            <img src="/img/dollarCoin.png" alt="dollar" width="16" />
                            ${value.toLocaleString()}</span>
                      </div>
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] border-b border-white/10 py-2'>
                          <span class='text-white font-[400]'>COINFLIP PROFIT</span>
                          <span class='text-white font-[800] flex items-center gap-1'>
                            <img src="/img/dollarCoin.png" alt="dollar" width="16" />
                            ${value.toLocaleString()}</span>
                      </div>
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] border-b border-white/10 py-2'>
                          <span class='text-white font-[400]'>COINFLIP RAKED</span>
                          <span class='text-white font-[800] flex items-center gap-1'>
                            <img src="/img/dollarCoin.png" alt="dollar" width="16" />
                            ${value.toLocaleString()}</span>
                      </div>
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] pt-2'>
                          <span class='text-white font-[400]'>REWARD EARMED</span>
                          <span class='text-white font-[800] flex items-center gap-1'>
                            <img src="/img/dollarCoin.png" alt="dollar" width="16" />
                            13,231.54</span>
                      </div>
