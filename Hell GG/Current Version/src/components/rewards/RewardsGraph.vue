<template>
  <div class="h-[300px] w-full my-5 relative">
    ...
    <div id="rewards-chartjs-tooltip" class="custom-tooltip"></div>
  </div>
</template>
<script>
        ...
        plugins: {
          ...
          tooltip: {
            ...
            external: (context) => {
              ...
              const tooltipEl = document.getElementById("rewards-chartjs-tooltip");
                ...
                tooltipEl.innerHTML = `
                  <div class='bg-[#620101] p-3 rounded-sm flex flex-col w-max border border-solid border-[rgba(255,52,53,0.4)] shadow-2xl'>
                      ...
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] border-b border-white/10 py-2'>
                          <span class='text-white font-[400]'>TOTAL REWARDED</span>
                          <span class='text-white font-[800] flex items-center gap-1'>
                            <img src="/img/dollarCoin.png" alt="dollar" width="16" />
                            ${value.toLocaleString()}</span>
                      </div>
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] border-b border-white/10 py-2'>
                          <span class='text-white font-[400]'>LVL CASE OPENED</span>
                          <span class='text-white font-[800]'>12</span>
                      </div>
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] border-b border-white/10 py-2'>
                          <span class='text-white font-[400]'>LVL CASES REWARDED</span>
                          <span class='text-white font-[800] flex items-center gap-1'>
                            <img src="/img/dollarCoin.png" alt="dollar" width="16" />
                            13,231.54</span>
                      </div>
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] border-b border-white/10 py-2'>
                          <span class='text-white font-[400]'>FAUCETS CLAIMED</span>
                          <span class='text-white font-[800]'>12</span>
                      </div>
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] border-b border-white/10 py-2'>
                          <span class='text-white font-[400]'>FAUCET REWARDED</span>
                          <span class='text-white font-[800]'>12</span>
                      </div>
                      <div class='flex items-center justify-between text-white gap-2 font-Rubik text-[10px] pt-2'>
                          <span class='text-white font-[400]'>USERS REWARDED</span>
                          <span class='text-white font-[800]'>12</span>
                      </div>
                  </div>`;
              }
