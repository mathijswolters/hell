      ...
      <div class="flex items-center flex-col w-full px-4 py-4 gap-4">
          ...
          >
            ...
            <div class="cursor-pointer info flex justify-center">
              ...
              >
                ...
                2.You will receive a trade offer for your skins. Please accept it in order
                to create the coinflip.
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div class="absolute top-2.5 right-3">
                <div class="relative cursor-pointer info flex justify-center">
                  ...
                  >
                    This will randomly select either heaven or hell to create the coinflip
                    on.
                  </div>
                </div>
              </div>
        ...
        >
          ...
          <div class="flex items-center justify-center xl:justify-end gap-2 flex-wrap">
            ...
            >
              <span class="font-Rubik font-semibold text-sm text-[#d7b7b7]"
                >SORT BY:</span
              >
              <div
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  "
                  :class="{
                    'opacity-60 bg-[#e82d2e] cursor-default': item == selected_time,
                  }"
                >
