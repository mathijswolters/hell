                  ...
                  >
                    <div class="relative flex items-center transition-opacity duration-200">
                      <div class="rounded-full -right-2 w-4 absolute">
                        <img
                          :src="`/img/coins/${previous_battle.players[0].coin}.svg`"
                          class="w-full h-full"
                        />
                      </div>
                    ...
                    >
                      <div class="border-[2px] border-[#740c0a] rounded-full -left-2 w-4 absolute">
                        <img
                          :src="`/img/coins/${previous_battle.players[1].coin}.svg`"
                          class="w-full h-full"
                        />
                      </div>
              ...
              <div id="coin_container" class="transition-all duration-[4500ms] z-10">
                ...
                >
                  <div id="front" :class="{ win: battle.state == 'finished' }">
                    <img src="/img/coins/heaven.svg" />
                  </div>
                  <div id="back" :class="{ win: battle.state == 'finished' }">
                    <img src="/img/coins/hell.svg" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="battle.players.length == 1" class="flex justify-center order-2">
            ...
            >
              ...
              <button
                ...
                @click="signedIn = true"
              >
                <img class="w-[22px]" src="../../assets/icons/steam.svg" />
                LOG IN WITH STEAM
              </button>
            </div>
          </div>
...
#front {
  /* background-image: url(/img/coins/heaven.svg); */
  z-index: 2;
}
#front.win {
...
#back {
  /* background-image: url(/img/coins/hell.svg); */
  transform: rotateY(180deg);
}
