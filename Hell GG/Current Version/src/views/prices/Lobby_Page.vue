    ...
    <div class="table-wrapper">
      <div class="flex gap-2 items-center">
        ...
        <button
          ...
          class="text-white w-[max-content] md:p-3 p-2 bg-[#FF3435] text-[16px] font-[800] uppercase"
        >
          Add Item
        </button>
      </div>
      <table class="theme-table">
        ...
        <tbody>
          <tr v-for="(item, index) in paginatedTableData" :key="index">
            ...
            <td>{{ item.last_appearence }}</td>

            <td>
              <button class="table-btn green" @click="openModal('more_info', item)">
                EDIT ITEM
              </button>
            </td>
          </tr>
